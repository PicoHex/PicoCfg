// AOT Compatibility Validation for Pico.CFG
// This program validates that all Pico.CFG features work correctly in AOT-compiled mode

using Pico.CFG;
using Pico.CFG.Extensions;

Console.WriteLine("=== Pico.CFG AOT Compatibility Validation ===");
Console.WriteLine();
...
{
    Console.WriteLine("✅ All tests passed! Pico.CFG is AOT compatible.");
    return 0;
}
else
{
