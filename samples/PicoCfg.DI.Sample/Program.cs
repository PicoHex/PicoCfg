...
Console.WriteLine($"Root Snapshot App:Name = {resolvedRoot.Snapshot.GetValue("App:Name")}");
...
AssertEqual("Root Snapshot App:Name", resolvedRoot.Snapshot.GetValue("App:Name"), "PicoCfg.DI");
